...
namespace Org.OpenAPITools.Api
{
    ...
    public interface IScreenshotApi : IApiAccessor
    {
        ...
        /// <param name="fileType">The image file format of the captured screenshot. Either png, jpeg or PDF with 72 dpi. (optional)</param>
        ...
        /// <param name="scale">The scale factor of the device to use when taking the screenshot. For example, a scale factor of 2 produces a high-resolution screenshot suitable for viewing on Retina devices. The larger the scale factor, the larger the screenshot produced. (optional, default to 1.0M)</param>
        ...
        /// <param name="latitude">The latitude used in the emulation of the geo-location. (optional, default to 0.0M)</param>
        /// <param name="longitude">The longitude used in the emulation of the geo-location. (optional, default to 0.0M)</param>
        /// <param name="accuracy">The accuracy in meters used in the emulation of the geo-location. (optional, default to 2.0M)</param>
        ...
        System.IO.Stream PlaceScreenshotOrderAuthenticated (string token, string hash, string url, string fileType = default(string), long? ttl = default(long?), bool? invalidate = default(bool?), bool? full = default(bool?), bool? lazyloadScroll = default(bool?), long? delay = default(long?), long? width = default(long?), long? height = default(long?), long? quality = default(long?), decimal? scale = default(decimal?), long? x = default(long?), long? y = default(long?), bool? redirect = default(bool?), string language = default(string), bool? randomUserAgent = default(bool?), string userAgent = default(string), string headers = default(string), string cookies = default(string), string css = default(string), string js = default(string), string wait = default(string), string element = default(string), string timezone = default(string), string device = default(string), decimal? latitude = default(decimal?), decimal? longitude = default(decimal?), decimal? accuracy = default(decimal?), string proxy = default(string), bool? adblock = default(bool?), bool? hideCookieBanners = default(bool?));
        ...
        ApiResponse<System.IO.Stream> PlaceScreenshotOrderAuthenticatedWithHttpInfo (string token, string hash, string url, string fileType = default(string), long? ttl = default(long?), bool? invalidate = default(bool?), bool? full = default(bool?), bool? lazyloadScroll = default(bool?), long? delay = default(long?), long? width = default(long?), long? height = default(long?), long? quality = default(long?), decimal? scale = default(decimal?), long? x = default(long?), long? y = default(long?), bool? redirect = default(bool?), string language = default(string), bool? randomUserAgent = default(bool?), string userAgent = default(string), string headers = default(string), string cookies = default(string), string css = default(string), string js = default(string), string wait = default(string), string element = default(string), string timezone = default(string), string device = default(string), decimal? latitude = default(decimal?), decimal? longitude = default(decimal?), decimal? accuracy = default(decimal?), string proxy = default(string), bool? adblock = default(bool?), bool? hideCookieBanners = default(bool?));
        /// <summary>
        /// 
        /// </summary>
        /// <remarks>
        ...
        /// <param name="hideCookieBanners">Prevent cookie banners and pop-ups from being displayed. The best possible result is tried. (optional, default to false)</param>
        /// <returns>System.IO.Stream</returns>
        System.IO.Stream PlaceScreenshotOrderUnauthenticated (string token, string url, string fileType = default(string), long? ttl = default(long?), bool? invalidate = default(bool?), bool? full = default(bool?), bool? lazyloadScroll = default(bool?), long? delay = default(long?), long? width = default(long?), long? height = default(long?), long? quality = default(long?), decimal? scale = default(decimal?), long? x = default(long?), long? y = default(long?), bool? redirect = default(bool?), string language = default(string), bool? randomUserAgent = default(bool?), string userAgent = default(string), string headers = default(string), string cookies = default(string), string css = default(string), string js = default(string), string wait = default(string), string element = default(string), string timezone = default(string), string device = default(string), decimal? latitude = default(decimal?), decimal? longitude = default(decimal?), decimal? accuracy = default(decimal?), string proxy = default(string), bool? adblock = default(bool?), bool? hideCookieBanners = default(bool?));
        ...
        /// <param name="hideCookieBanners">Prevent cookie banners and pop-ups from being displayed. The best possible result is tried. (optional, default to false)</param>
        /// <returns>ApiResponse of System.IO.Stream</returns>
        ApiResponse<System.IO.Stream> PlaceScreenshotOrderUnauthenticatedWithHttpInfo (string token, string url, string fileType = default(string), long? ttl = default(long?), bool? invalidate = default(bool?), bool? full = default(bool?), bool? lazyloadScroll = default(bool?), long? delay = default(long?), long? width = default(long?), long? height = default(long?), long? quality = default(long?), decimal? scale = default(decimal?), long? x = default(long?), long? y = default(long?), bool? redirect = default(bool?), string language = default(string), bool? randomUserAgent = default(bool?), string userAgent = default(string), string headers = default(string), string cookies = default(string), string css = default(string), string js = default(string), string wait = default(string), string element = default(string), string timezone = default(string), string device = default(string), decimal? latitude = default(decimal?), decimal? longitude = default(decimal?), decimal? accuracy = default(decimal?), string proxy = default(string), bool? adblock = default(bool?), bool? hideCookieBanners = default(bool?));
        ...
        System.Threading.Tasks.Task<System.IO.Stream> PlaceScreenshotOrderAuthenticatedAsync (string token, string hash, string url, string fileType = default(string), long? ttl = default(long?), bool? invalidate = default(bool?), bool? full = default(bool?), bool? lazyloadScroll = default(bool?), long? delay = default(long?), long? width = default(long?), long? height = default(long?), long? quality = default(long?), decimal? scale = default(decimal?), long? x = default(long?), long? y = default(long?), bool? redirect = default(bool?), string language = default(string), bool? randomUserAgent = default(bool?), string userAgent = default(string), string headers = default(string), string cookies = default(string), string css = default(string), string js = default(string), string wait = default(string), string element = default(string), string timezone = default(string), string device = default(string), decimal? latitude = default(decimal?), decimal? longitude = default(decimal?), decimal? accuracy = default(decimal?), string proxy = default(string), bool? adblock = default(bool?), bool? hideCookieBanners = default(bool?), CancellationToken cancellationToken = default(CancellationToken));
        ...
        System.Threading.Tasks.Task<ApiResponse<System.IO.Stream>> PlaceScreenshotOrderAuthenticatedWithHttpInfoAsync (string token, string hash, string url, string fileType = default(string), long? ttl = default(long?), bool? invalidate = default(bool?), bool? full = default(bool?), bool? lazyloadScroll = default(bool?), long? delay = default(long?), long? width = default(long?), long? height = default(long?), long? quality = default(long?), decimal? scale = default(decimal?), long? x = default(long?), long? y = default(long?), bool? redirect = default(bool?), string language = default(string), bool? randomUserAgent = default(bool?), string userAgent = default(string), string headers = default(string), string cookies = default(string), string css = default(string), string js = default(string), string wait = default(string), string element = default(string), string timezone = default(string), string device = default(string), decimal? latitude = default(decimal?), decimal? longitude = default(decimal?), decimal? accuracy = default(decimal?), string proxy = default(string), bool? adblock = default(bool?), bool? hideCookieBanners = default(bool?), CancellationToken cancellationToken = default(CancellationToken));
        /// <summary>
        /// 
        /// </summary>
        /// <remarks>
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel request (optional) </param>
        /// <returns>Task of System.IO.Stream</returns>
        System.Threading.Tasks.Task<System.IO.Stream> PlaceScreenshotOrderUnauthenticatedAsync (string token, string url, string fileType = default(string), long? ttl = default(long?), bool? invalidate = default(bool?), bool? full = default(bool?), bool? lazyloadScroll = default(bool?), long? delay = default(long?), long? width = default(long?), long? height = default(long?), long? quality = default(long?), decimal? scale = default(decimal?), long? x = default(long?), long? y = default(long?), bool? redirect = default(bool?), string language = default(string), bool? randomUserAgent = default(bool?), string userAgent = default(string), string headers = default(string), string cookies = default(string), string css = default(string), string js = default(string), string wait = default(string), string element = default(string), string timezone = default(string), string device = default(string), decimal? latitude = default(decimal?), decimal? longitude = default(decimal?), decimal? accuracy = default(decimal?), string proxy = default(string), bool? adblock = default(bool?), bool? hideCookieBanners = default(bool?), CancellationToken cancellationToken = default(CancellationToken));
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel request (optional) </param>
        /// <returns>Task of ApiResponse (System.IO.Stream)</returns>
        System.Threading.Tasks.Task<ApiResponse<System.IO.Stream>> PlaceScreenshotOrderUnauthenticatedWithHttpInfoAsync (string token, string url, string fileType = default(string), long? ttl = default(long?), bool? invalidate = default(bool?), bool? full = default(bool?), bool? lazyloadScroll = default(bool?), long? delay = default(long?), long? width = default(long?), long? height = default(long?), long? quality = default(long?), decimal? scale = default(decimal?), long? x = default(long?), long? y = default(long?), bool? redirect = default(bool?), string language = default(string), bool? randomUserAgent = default(bool?), string userAgent = default(string), string headers = default(string), string cookies = default(string), string css = default(string), string js = default(string), string wait = default(string), string element = default(string), string timezone = default(string), string device = default(string), decimal? latitude = default(decimal?), decimal? longitude = default(decimal?), decimal? accuracy = default(decimal?), string proxy = default(string), bool? adblock = default(bool?), bool? hideCookieBanners = default(bool?), CancellationToken cancellationToken = default(CancellationToken));
    ...
    public partial class ScreenshotApi : IScreenshotApi
    {
        ...
        /// <returns></returns>
        public ScreenshotApi(Org.OpenAPITools.Client.Configuration configuration = null)
        {
        ...
        /// <param name="hideCookieBanners">Prevent cookie banners and pop-ups from being displayed. The best possible result is tried. (optional, default to false)</param>
        /// <returns>System.IO.Stream</returns>
        public System.IO.Stream PlaceScreenshotOrderAuthenticated (string token, string hash, string url, string fileType = default(string), long? ttl = default(long?), bool? invalidate = default(bool?), bool? full = default(bool?), bool? lazyloadScroll = default(bool?), long? delay = default(long?), long? width = default(long?), long? height = default(long?), long? quality = default(long?), decimal? scale = default(decimal?), long? x = default(long?), long? y = default(long?), bool? redirect = default(bool?), string language = default(string), bool? randomUserAgent = default(bool?), string userAgent = default(string), string headers = default(string), string cookies = default(string), string css = default(string), string js = default(string), string wait = default(string), string element = default(string), string timezone = default(string), string device = default(string), decimal? latitude = default(decimal?), decimal? longitude = default(decimal?), decimal? accuracy = default(decimal?), string proxy = default(string), bool? adblock = default(bool?), bool? hideCookieBanners = default(bool?))
        {
             ApiResponse<System.IO.Stream> localVarResponse = PlaceScreenshotOrderAuthenticatedWithHttpInfo(token, hash, url, fileType, ttl, invalidate, full, lazyloadScroll, delay, width, height, quality, scale, x, y, redirect, language, randomUserAgent, userAgent, headers, cookies, css, js, wait, element, timezone, device, latitude, longitude, accuracy, proxy, adblock, hideCookieBanners);
        ...
        /// <param name="hideCookieBanners">Prevent cookie banners and pop-ups from being displayed. The best possible result is tried. (optional, default to false)</param>
        /// <returns>ApiResponse of System.IO.Stream</returns>
        public ApiResponse<System.IO.Stream> PlaceScreenshotOrderAuthenticatedWithHttpInfo (string token, string hash, string url, string fileType = default(string), long? ttl = default(long?), bool? invalidate = default(bool?), bool? full = default(bool?), bool? lazyloadScroll = default(bool?), long? delay = default(long?), long? width = default(long?), long? height = default(long?), long? quality = default(long?), decimal? scale = default(decimal?), long? x = default(long?), long? y = default(long?), bool? redirect = default(bool?), string language = default(string), bool? randomUserAgent = default(bool?), string userAgent = default(string), string headers = default(string), string cookies = default(string), string css = default(string), string js = default(string), string wait = default(string), string element = default(string), string timezone = default(string), string device = default(string), decimal? latitude = default(decimal?), decimal? longitude = default(decimal?), decimal? accuracy = default(decimal?), string proxy = default(string), bool? adblock = default(bool?), bool? hideCookieBanners = default(bool?))
        {
            // verify the required parameter 'token' is set
            if (token == null)
                throw new ApiException(400, "Missing required parameter 'token' when calling ScreenshotApi->PlaceScreenshotOrderAuthenticated");
            // verify the required parameter 'hash' is set
            if (hash == null)
                throw new ApiException(400, "Missing required parameter 'hash' when calling ScreenshotApi->PlaceScreenshotOrderAuthenticated");
            // verify the required parameter 'url' is set
            if (url == null)
                throw new ApiException(400, "Missing required parameter 'url' when calling ScreenshotApi->PlaceScreenshotOrderAuthenticated");
            ...
            {
                Exception exception = ExceptionFactory("PlaceScreenshotOrderAuthenticated", localVarResponse);
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel request (optional) </param>
        /// <returns>Task of System.IO.Stream</returns>
        public async System.Threading.Tasks.Task<System.IO.Stream> PlaceScreenshotOrderAuthenticatedAsync (string token, string hash, string url, string fileType = default(string), long? ttl = default(long?), bool? invalidate = default(bool?), bool? full = default(bool?), bool? lazyloadScroll = default(bool?), long? delay = default(long?), long? width = default(long?), long? height = default(long?), long? quality = default(long?), decimal? scale = default(decimal?), long? x = default(long?), long? y = default(long?), bool? redirect = default(bool?), string language = default(string), bool? randomUserAgent = default(bool?), string userAgent = default(string), string headers = default(string), string cookies = default(string), string css = default(string), string js = default(string), string wait = default(string), string element = default(string), string timezone = default(string), string device = default(string), decimal? latitude = default(decimal?), decimal? longitude = default(decimal?), decimal? accuracy = default(decimal?), string proxy = default(string), bool? adblock = default(bool?), bool? hideCookieBanners = default(bool?), CancellationToken cancellationToken = default(CancellationToken))
        {
             ApiResponse<System.IO.Stream> localVarResponse = await PlaceScreenshotOrderAuthenticatedWithHttpInfoAsync(token, hash, url, fileType, ttl, invalidate, full, lazyloadScroll, delay, width, height, quality, scale, x, y, redirect, language, randomUserAgent, userAgent, headers, cookies, css, js, wait, element, timezone, device, latitude, longitude, accuracy, proxy, adblock, hideCookieBanners, cancellationToken);
             return localVarResponse.Data;
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel request (optional) </param>
        /// <returns>Task of ApiResponse (System.IO.Stream)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<System.IO.Stream>> PlaceScreenshotOrderAuthenticatedWithHttpInfoAsync (string token, string hash, string url, string fileType = default(string), long? ttl = default(long?), bool? invalidate = default(bool?), bool? full = default(bool?), bool? lazyloadScroll = default(bool?), long? delay = default(long?), long? width = default(long?), long? height = default(long?), long? quality = default(long?), decimal? scale = default(decimal?), long? x = default(long?), long? y = default(long?), bool? redirect = default(bool?), string language = default(string), bool? randomUserAgent = default(bool?), string userAgent = default(string), string headers = default(string), string cookies = default(string), string css = default(string), string js = default(string), string wait = default(string), string element = default(string), string timezone = default(string), string device = default(string), decimal? latitude = default(decimal?), decimal? longitude = default(decimal?), decimal? accuracy = default(decimal?), string proxy = default(string), bool? adblock = default(bool?), bool? hideCookieBanners = default(bool?), CancellationToken cancellationToken = default(CancellationToken))
        {
            // verify the required parameter 'token' is set
            if (token == null)
                throw new ApiException(400, "Missing required parameter 'token' when calling ScreenshotApi->PlaceScreenshotOrderAuthenticated");
        ...
        /// <param name="hideCookieBanners">Prevent cookie banners and pop-ups from being displayed. The best possible result is tried. (optional, default to false)</param>
        /// <returns>System.IO.Stream</returns>
        public System.IO.Stream PlaceScreenshotOrderUnauthenticated (string token, string url, string fileType = default(string), long? ttl = default(long?), bool? invalidate = default(bool?), bool? full = default(bool?), bool? lazyloadScroll = default(bool?), long? delay = default(long?), long? width = default(long?), long? height = default(long?), long? quality = default(long?), decimal? scale = default(decimal?), long? x = default(long?), long? y = default(long?), bool? redirect = default(bool?), string language = default(string), bool? randomUserAgent = default(bool?), string userAgent = default(string), string headers = default(string), string cookies = default(string), string css = default(string), string js = default(string), string wait = default(string), string element = default(string), string timezone = default(string), string device = default(string), decimal? latitude = default(decimal?), decimal? longitude = default(decimal?), decimal? accuracy = default(decimal?), string proxy = default(string), bool? adblock = default(bool?), bool? hideCookieBanners = default(bool?))
        {
             ApiResponse<System.IO.Stream> localVarResponse = PlaceScreenshotOrderUnauthenticatedWithHttpInfo(token, url, fileType, ttl, invalidate, full, lazyloadScroll, delay, width, height, quality, scale, x, y, redirect, language, randomUserAgent, userAgent, headers, cookies, css, js, wait, element, timezone, device, latitude, longitude, accuracy, proxy, adblock, hideCookieBanners);
             return localVarResponse.Data;
        }
        ...
        /// <param name="hideCookieBanners">Prevent cookie banners and pop-ups from being displayed. The best possible result is tried. (optional, default to false)</param>
        /// <returns>ApiResponse of System.IO.Stream</returns>
        public ApiResponse<System.IO.Stream> PlaceScreenshotOrderUnauthenticatedWithHttpInfo (string token, string url, string fileType = default(string), long? ttl = default(long?), bool? invalidate = default(bool?), bool? full = default(bool?), bool? lazyloadScroll = default(bool?), long? delay = default(long?), long? width = default(long?), long? height = default(long?), long? quality = default(long?), decimal? scale = default(decimal?), long? x = default(long?), long? y = default(long?), bool? redirect = default(bool?), string language = default(string), bool? randomUserAgent = default(bool?), string userAgent = default(string), string headers = default(string), string cookies = default(string), string css = default(string), string js = default(string), string wait = default(string), string element = default(string), string timezone = default(string), string device = default(string), decimal? latitude = default(decimal?), decimal? longitude = default(decimal?), decimal? accuracy = default(decimal?), string proxy = default(string), bool? adblock = default(bool?), bool? hideCookieBanners = default(bool?))
        {
            // verify the required parameter 'token' is set
            if (token == null)
                throw new ApiException(400, "Missing required parameter 'token' when calling ScreenshotApi->PlaceScreenshotOrderUnauthenticated");
            // verify the required parameter 'url' is set
            if (url == null)
                throw new ApiException(400, "Missing required parameter 'url' when calling ScreenshotApi->PlaceScreenshotOrderUnauthenticated");
            ...
            if (ExceptionFactory != null)
            {
                Exception exception = ExceptionFactory("PlaceScreenshotOrderUnauthenticated", localVarResponse);
                if (exception != null) throw exception;
            }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel request (optional) </param>
        /// <returns>Task of System.IO.Stream</returns>
        public async System.Threading.Tasks.Task<System.IO.Stream> PlaceScreenshotOrderUnauthenticatedAsync (string token, string url, string fileType = default(string), long? ttl = default(long?), bool? invalidate = default(bool?), bool? full = default(bool?), bool? lazyloadScroll = default(bool?), long? delay = default(long?), long? width = default(long?), long? height = default(long?), long? quality = default(long?), decimal? scale = default(decimal?), long? x = default(long?), long? y = default(long?), bool? redirect = default(bool?), string language = default(string), bool? randomUserAgent = default(bool?), string userAgent = default(string), string headers = default(string), string cookies = default(string), string css = default(string), string js = default(string), string wait = default(string), string element = default(string), string timezone = default(string), string device = default(string), decimal? latitude = default(decimal?), decimal? longitude = default(decimal?), decimal? accuracy = default(decimal?), string proxy = default(string), bool? adblock = default(bool?), bool? hideCookieBanners = default(bool?), CancellationToken cancellationToken = default(CancellationToken))
        {
             ApiResponse<System.IO.Stream> localVarResponse = await PlaceScreenshotOrderUnauthenticatedWithHttpInfoAsync(token, url, fileType, ttl, invalidate, full, lazyloadScroll, delay, width, height, quality, scale, x, y, redirect, language, randomUserAgent, userAgent, headers, cookies, css, js, wait, element, timezone, device, latitude, longitude, accuracy, proxy, adblock, hideCookieBanners, cancellationToken);
             return localVarResponse.Data;
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel request (optional) </param>
        /// <returns>Task of ApiResponse (System.IO.Stream)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<System.IO.Stream>> PlaceScreenshotOrderUnauthenticatedWithHttpInfoAsync (string token, string url, string fileType = default(string), long? ttl = default(long?), bool? invalidate = default(bool?), bool? full = default(bool?), bool? lazyloadScroll = default(bool?), long? delay = default(long?), long? width = default(long?), long? height = default(long?), long? quality = default(long?), decimal? scale = default(decimal?), long? x = default(long?), long? y = default(long?), bool? redirect = default(bool?), string language = default(string), bool? randomUserAgent = default(bool?), string userAgent = default(string), string headers = default(string), string cookies = default(string), string css = default(string), string js = default(string), string wait = default(string), string element = default(string), string timezone = default(string), string device = default(string), decimal? latitude = default(decimal?), decimal? longitude = default(decimal?), decimal? accuracy = default(decimal?), string proxy = default(string), bool? adblock = default(bool?), bool? hideCookieBanners = default(bool?), CancellationToken cancellationToken = default(CancellationToken))
        {
            // verify the required parameter 'token' is set
            if (token == null)
                throw new ApiException(400, "Missing required parameter 'token' when calling ScreenshotApi->PlaceScreenshotOrderUnauthenticated");
